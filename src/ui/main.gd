...
const CREDITS_LINES := [
	...
	["Roger Bergling · Kevin Christiansen (PE) · Brad Cramer", 53, 2],
	["Claude Fable 5 · Trevor Flurry · Henry Hannah · Patrick Hannah", 53, 2],
	["Shannon (Learn) Koski · Beaux Onofrio · Nick Onofrio", 53, 2],
