...
const CREDITS_LINES := [
	...
	["Roger Bergling · Al Bredthauer · Samuel Bredthauer · Kevin Christiansen (PE)", 53, 2],
	["Brad Cramer · Fable5/Opus4.8 · Trevor Flurry · Henry Hannah", 53, 2],
	["Patrick Hannah · Noureddine Najah Khalifa · Shannon (Learn) Koski · Beaux Onofrio", 53, 2],
	["Nick Onofrio · Rob Orr · Mark Schantz · Adam Testagrossa", 53, 2],
	["Nate Tiller · John Van Lowe · Jeremy Zhao", 53, 2],
	["", 35, 3],
	["PROGRAMMING", 65, 1],
	["Fable5/Opus4.8", 53, 2],
	["", 35, 3],
