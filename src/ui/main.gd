...
const CREDITS_LINES := [
	...
	["", 35, 3],
	["PLAY TESTERS", 65, 1],
	["Kevin Christiansen (PE) · Claude Fable 5 · Trevor Flurry · Henry Hannah", 53, 2],
	["Patrick Hannah · Shannon (Learn) Koski · Beaux Onofrio · Nick Onofrio", 53, 2],
	["Adam Testagrossa · Nate Tiller · Jeremy Zhao", 53, 2],
	["", 35, 3],
	["PROGRAMMING", 65, 1],
	["Claude Fable 5", 53, 2],
	["", 35, 3],
